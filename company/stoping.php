                ...
                <table  class="table table-bordered table-striped table-hover">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td><a href="#">0</a></td>
                            <td>
								<a href="javascript:;" class="repost" action="<?php echo base_url('index.php/company/job_repost?id='.$d["id"]); ?>">重新发布</a>
